...
The packages in the `dynamixel_workbench_msgs` repository were released into the `rolling` distro by running `/usr/bin/bloom-release dynamixel_workbench_msgs -t rolling -r rolling` on `Thu, 06 Oct 2022 07:38:12 -0000`
...
The packages in the `dynamixel_workbench_msgs` repository were released into the `humble` distro by running `/usr/bin/bloom-release dynamixel_workbench_msgs -t humble -r humble` on `Thu, 06 Oct 2022 07:28:19 -0000`
